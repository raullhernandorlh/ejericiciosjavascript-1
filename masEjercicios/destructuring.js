...
// Con slice el primer numero cuenta la posicion del elemento del array desde donde empieza a contar y con el segundo parametro indica hasta
// que numero de elementpo
 const ultimos = numbers.slice(2, 4);
 const primeros = numbers.slice(0,2);
 console.log(ultimos);
...
// Se dividira el string por donde aparece el simbolo. En este caso por la ,
