...
// EN ESTA PARTE TENEMOS VARIAS "PROMESAS ENCADENADAS". ¿Como sabemos que son varias promesas?. Por cada "then" un promesa

// ----- PRIMERA PROMESA QUE DEVUELVE LOS DATOS DE LAS BANDERAS  AZULES DEL 2017 DEL AYUNATAMIENTO DE BOIRO ------------------

axios
    // En esta linea cogemos los datos con las banderas de las playas gallegas 2017
    ...
    .then( response => {
        ...
        return axios
        // En esta linea cogemos los datos con las banderas de las platas gallegas de 2018
...
// ----- SEGUNDA PROMESA QUE DEVUELVE LOS DATOS DE LAS BANDERAS  AZULES DEL 2018 DEL AYUNATAMIENTO DE BOIRO . Sabemos que es promesa porque tiene el return---------------------------
    ...
    .then( response => {
        ...
        return  axios
        // En esta linea cogemos los datos con las banderas de las platas gallegas de 2019
...
// ----- TERCERA PROMESA QUE DEVUELVE LOS DATOS DE LAS BANDERAS  AZULES DEL 2018 DEL AYUNATAMIENTO DE BOIRO ---------------------------
